...
class TestTimeRange(TestCase):
    def test_get_start_date_of_week(self):
        ...
        assert start_date == datetime.datetime(2020, 9, 14)
    ...
    def test_get_start_date_of_month(self):
        ...
        assert start_date == datetime.datetime(2020, 9, 1)
    ...
    def test_get_end_date_of_week(self):
        ...
        assert end_date == datetime.datetime(2020, 9, 20, 23, 59, 59, 999999)
    ...
    def test_get_end_date_of_month(self):
        ...
        assert end_date == datetime.datetime(2020, 9, 30, 23, 59, 59, 999999)
