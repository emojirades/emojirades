...
Revision ID: 8423d701dfb0
Revises: 
Create Date: 2021-08-15 10:53:46.608731
...
def upgrade():
    ...
    sa.Column('step', sa.Enum('NEW_GAME', 'WAITING', 'PROVIDED', 'GUESSING', name='gamestatestep'), nullable=False),
    ...
    op.create_table('gamestate_history',
    ...
    op.create_index('idx_gamestate_history_channel', 'gamestate_history', ['workspace_id', 'channel_id'], unique=False)
    ...
    op.create_table('scoreboard_history',
    sa.Column('event_id', sa.BigInteger(), sa.Identity(always=False), nullable=False),
    sa.Column('workspace_id', sa.Text(), nullable=True),
    sa.Column('channel_id', sa.Text(), nullable=True),
    sa.Column('user_id', sa.Text(), nullable=True),
